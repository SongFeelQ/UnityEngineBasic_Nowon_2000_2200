...
namespace Operators
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // 나누기 : 정수간의 나눗셈은 정수 몫만 반환, 실수간의 나눗셈은 실수로 반환
            c = a / b;
            Console.WriteLine(c);

            // 나머지 : 정수연산시의 (정수 몫 * 오른쪽 피연산자)를 왼쪽 피연산자에 뺀 값을 반환
            c = a % b;
            Console.WriteLine(c);
            ...
            c++; // 후위 연산 : 해당 라인에서 명령을 먼저 실행한 후에 연산실행
            c = 0;
            Console.WriteLine(++c);
            Console.WriteLine(c++);
            Console.WriteLine(c);
            ...
            // 관계 연산
            // 같음, 다름, 크기비교 연산자
            // 관계 연산자의 연산결과가 참이면 true, 거짓이면 false를 반환
            ...
            // and
            // a와 b 둘다 true 면 true 반환, 나머지 경우 false 반환
            Console.WriteLine(A & B);

            // xor
            // a와 b 둘중 하나만 true 면 true 반환, 나머지 경우 false 반환
            Console.WriteLine(A ^ B);
